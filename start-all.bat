...
if not exist "D:\feedWeb\frontend\node_modules" (
    echo [2/4] Installing frontend dependencies...
    cd /d D:\feedWeb\frontend
    call npm install
)

:: Start Python AI Service
echo [3/4] Starting Python AI Service on port 8000...
start "AI Service" cmd /k "cd /d D:\feedWeb\ai-service && echo Installing Python deps... && pip install -q -r requirements.txt && echo Starting AI Service... && python main.py"
