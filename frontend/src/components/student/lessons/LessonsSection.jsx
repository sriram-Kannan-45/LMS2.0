        ...
        <div className="ls-grid">
          {[1, 2, 3, 4, 5, 6].map((i) => (
            <div key={i} className="ls-card">
              <div className="ac-skeleton" style={{ height: 88, borderRadius: 0, marginBottom: 0 }} />
              <div className="ls-card__body">
                <div className="ac-skeleton" style={{ height: 18, width: '85%', marginBottom: 8 }} />
                <div className="ac-skeleton" style={{ height: 14, width: '95%', marginBottom: 4 }} />
                <div className="ac-skeleton" style={{ height: 14, width: '60%', marginBottom: 14 }} />
                <div className="ac-skeleton" style={{ height: 1, width: '100%', marginBottom: 14 }} />
                <div className="ac-skeleton" style={{ height: 12, width: '100%', marginBottom: 16 }} />
                <div className="ac-skeleton" style={{ height: 40, width: '100%' }} />
              </div>
            </div>
          ))}
        </div>
