...
/* ─── Robot speech bubble + floating cards ─── */
...
/* ─── Role Config ─── */
const roles = [
  { value: 'PARTICIPANT', label: 'Participant', icon: User, color: '#2563eb' },
  { value: 'TRAINER', label: 'Trainer', icon: GraduationCap, color: '#2563eb' },
  { value: 'ADMIN', label: 'Admin', icon: Shield, color: '#2563eb' },
]
...
function Login({ onLogin }) {
  ...
  // Lock the document scroll while Login is mounted so the page fits 100vh.
  useEffect(() => {
  ...
  return (
    <div className="classic-login-page">
      {/* ─── LEFT VISUAL PANEL — illustration + interactive AI cards ─── */}
      <aside className="login-visual-panel">
        ...
        {/* Interactive robot hotspot — click to reveal AI cards */}
        <motion.button
          type="button"
        ...
        {/* "AI Online" pill — always-visible status */}
        <motion.div
        ...
        {/* Floating AI feature cards — toggled by clicking the robot */}
        <AIFloatingCards visible={aiCardsVisible} />

        {/* Tap-hint that appears when cards are hidden */}
        <AnimatePresence>
          {!aiCardsVisible && (
            <motion.div
      ...
      <section className="login-form-panel">
        {/* Subtle background decoration on right */}
        ...
        >
          ...
          {/* Footer */}
          <p className="classic-footer">© 2026 · All rights reserved.</p>
        </motion.div>
      </section>

      <style>{`
        /* ═══════════════════════════════════════════════════════════
           SPLIT-SCREEN SAAS LOGIN — Modern AI Platform Aesthetic
           Left: visual panel (illustration + glow + gradient)
           Right: glassmorphism login card
           Locked to 100vh / 100dvh — no scrollbars.
           ═══════════════════════════════════════════════════════════ */
        ...
        /* ═══════════════════════════════════════════════════════════
           LEFT — VISUAL PANEL  (illustration only, edge-to-edge)
           ═══════════════════════════════════════════════════════════ */
        .login-visual-panel {
          flex: 1.35 1 0;
          position: relative;
          ...
          /* clip only the background, not the bubble overlay */
          clip-path: none;
        }
        ...
        .visual-image {
          ...
          height: 100%;
          object-fit: cover;
          /* Show boy fully on left, robot in center — flower pot pushed right/out */
        ...
        /* Whisper-thin tint to harmonise the image with the panel */
        ...
        /* ═══════════════════════════════════════════════════════════
           INTERACTIVE ROBOT HOTSPOT — pulsing, glowing click target
           positioned over the robot face inside the laptop screen.
           ═══════════════════════════════════════════════════════════ */
        .robot-hotspot {
          position: absolute;
          top: 38%;
        ...
        /* When active, swap the pulse for a calmer steady glow */
        ...
        /* ═══════════════════════════════════════════════════════════
           FLOATING AI FEATURE CARDS  (revealed on robot click)
           ═══════════════════════════════════════════════════════════ */
        .ai-cards-layer {
          position: absolute;
          inset: 0;
        ...
        /* tail points down-right toward the robot */
        .ai-bubble-tail {
          position: absolute;
          bottom: -9px;
          right: 28px;
        ...
        /* Floating "AI Online" pill — premium AI SaaS detail */
        .visual-float {
          position: absolute;
          z-index: 3;
          display: inline-flex;
        ...
        /* ═══════════════════════════════════════════════════════════
           RIGHT — FORM PANEL  (premium SaaS glass card)
           ═══════════════════════════════════════════════════════════ */
        .login-form-panel {
          flex: 1 1 0;
          position: relative;
        ...
        .classic-role-btn:hover .classic-role-icon { transform: scale(1.08); }
        ...
        .classic-role-btn.selected .classic-role-label {
          color: var(--role-color, var(--brand-600));
        }
        ...
        /* Tablets / small laptops — visual panel narrows slightly */
        ...
        /* Below 900px: hide the visual panel, form takes the stage */
        ...
        /* Very short viewports — drop non-essentials */
