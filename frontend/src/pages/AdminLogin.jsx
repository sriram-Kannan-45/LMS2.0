    ...
    <div className="classic-login-page">
      ...
      <section className="login-form-panel">
        ...
        >
          ...
          <div className="classic-login-card">
            ...
            <div className="classic-card-body">
              ...
              <div className="classic-title-section">
                ...
                <div>
                  <h2 className="classic-card-title">Admin Portal</h2>
                  <p className="classic-card-subtitle">Secure Management & Analytics Console</p>
                </div>
              </div>

              <div className="classic-welcome-banner">
                Access administrative tools, user configurations, and platform-wide monitoring.
              </div>
          ...
          {/* Footer */}
          <p className="classic-footer">© 2026 · FeedWeb LMS · Secure Admin Login</p>
        </motion.div>
      </section>
      ...
      <style>{`
        ...
        .classic-login-page {
          ...
          background: linear-gradient(135deg, #fff5f6 0%, #fff0f1 50%, #fffafb 100%);
        ...
        .login-visual-panel {
          ...
          isolation: isolate;
          background:
            radial-gradient(ellipse at 25% 20%, rgba(251,113,133,0.25) 0%, transparent 55%),
            radial-gradient(ellipse at 80% 80%, rgba(225,29,72,0.18) 0%, transparent 60%),
            linear-gradient(135deg, #ffe4e6 0%, #fff1f2 50%, #fffafb 100%);
          clip-path: none;
        }
        ...
        .visual-bg-gradient {
          ...
          inset: 0;
          background:
            radial-gradient(circle at 20% 30%, rgba(251,113,133,0.20) 0%, transparent 45%),
            radial-gradient(circle at 80% 70%, rgba(225,29,72,0.14) 0%, transparent 50%);
          pointer-events: none;
          z-index: 0;
        }
        ...
        .visual-glow-2 {
          ...
          bottom: -120px;
          right: -100px;
          background: radial-gradient(circle, rgba(253,164,175,0.55) 0%, transparent 70%);
        ...
        .ai-feature-card {
          ...
          box-shadow:
            ...
            0 8px 24px rgba(225,29,72,0.14),
        ...
        .ai-feature-icon {
          ...
          box-shadow:
            ...
            0 4px 10px color-mix(in srgb, var(--card-accent, #e11d48) 35%, transparent);
          flex-shrink: 0;
        }
        ...
        .ai-bubble {
          ...
          width: 210px;
          will-change: transform, opacity;
          filter: drop-shadow(0 8px 24px rgba(225,29,72,0.18));
        }
        ...
        .ai-bubble-inner {
          ...
          border: 1px solid rgba(254,228,230,0.9);
          ...
          box-shadow:
            ...
            0 12px 32px rgba(225,29,72,0.13);
          position: relative;
        }
        ...
        .ai-bubble-tail {
          ...
          height: 18px;
          background: rgba(255,255,255,0.96);
          border-right: 1px solid rgba(254,228,230,0.9);
          border-bottom: 1px solid rgba(254,228,230,0.9);
        ...
        .visual-float {
          ...
          box-shadow:
            ...
            0 6px 20px rgba(225,29,72,0.14);
        }
        ...
        .login-form-panel {
          ...
          overflow: hidden;
          background:
            radial-gradient(ellipse at 70% 0%, rgba(254,228,230,0.45) 0%, transparent 50%),
            radial-gradient(ellipse at 30% 100%, rgba(254,205,211,0.35) 0%, transparent 55%),
            linear-gradient(180deg, #ffffff 0%, #fffcfc 100%);
          min-width: 0;
        }
        ...
        .classic-bg-shape-2 {
          ...
          bottom: -180px;
          left: -110px;
          background: radial-gradient(circle, rgba(254,205,211,0.14) 0%, transparent 70%);
        }
        ...
        .classic-login-card {
          ...
          box-shadow:
            ...
            0 14px 36px rgba(225,29,72,0.09),
            0 28px 72px rgba(225,29,72,0.07);
          overflow: hidden;
          position: relative;
          flex-shrink: 0;
          transition:
        ...
        .classic-login-card:hover {
          box-shadow:
            0 1px 0 rgba(255,255,255,0.95) inset,
            0 1px 2px rgba(15,23,42,0.04),
            0 18px 44px rgba(225,29,72,0.13),
            0 36px 88px rgba(225,29,72,0.09);
        }
        ...
        .classic-checkbox:checked + .classic-checkmark {
          ...
          box-shadow: 0 2px 6px rgba(225,29,72,0.32);
        }
        ...
        .classic-submit-btn {
          ...
          box-shadow:
            ...
            0 10px 22px rgba(225,29,72,0.34),
            0 2px 6px rgba(225,29,72,0.22);
          position: relative;
          overflow: hidden;
          letter-spacing: 0.01em;
        }
        ...
        .classic-submit-btn:hover:not(:disabled) {
          ...
          box-shadow:
            0 1px 0 rgba(255,255,255,0.22) inset,
            0 14px 32px rgba(225,29,72,0.44),
            0 4px 10px rgba(225,29,72,0.26);
        ...
        .classic-switch-link:hover {
          ...
          color: var(--brand-700);
          transform: translateY(-1px);
          box-shadow: 0 4px 10px rgba(225,29,72,0.06);
        }
        ...
        @media (max-width: 900px) {
          ...
          .login-form-panel {
            flex: 1 1 100%;
            background:
              radial-gradient(ellipse at 50% 0%, rgba(254,228,230,0.55) 0%, transparent 55%),
              radial-gradient(ellipse at 50% 100%, rgba(254,205,211,0.4) 0%, transparent 60%),
              linear-gradient(180deg, #ffffff 0%, #fffcfc 100%);
          }
        }
